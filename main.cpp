...
void sound()
{
    ...
    PlaySound("car+driveby2.wav", NULL, SND_ASYNC|SND_FILENAME|SND_LOOP);
...
void sound1()
{
    ...
    PlaySound("helicopter.wav", NULL, SND_ASYNC|SND_FILENAME|SND_LOOP);
    //PlaySound("a.wav", NULL, SND_ASYNC|SND_FILENAME|SND_LOOP);
...
void sound3()
{
    ...
    PlaySound("rain storm.wav", NULL, SND_ASYNC|SND_FILENAME|SND_LOOP);
    //PlaySound("a.wav", NULL, SND_ASYNC|SND_FILENAME|SND_LOOP);
...
void sound4()
{
    ...
    PlaySound("nightsound.wav", NULL, SND_ASYNC|SND_FILENAME|SND_LOOP);
    //PlaySound("a.wav", NULL, SND_ASYNC|SND_FILENAME|SND_LOOP);
...
//road
if(mode) // day
    drawQuad(228,-240,320,-240,320,90,228,90,150, 170, 180);
else
    drawQuad(228,-240,320,-240,320,90,228,90,124, 145, 161);

drawQuad(228,-240,232,-240,232,90,228,90,32, 33, 33);
drawQuad(316,-240,320,-240,320,90,316,90,32, 33, 33);
...
glTranslatef(0.0, carp, 0.0);
drawCircle(255,25,8,32, 33, 33);//tire
drawCircle(281,25,8,32, 33, 33);

drawQuad(248,50,288,50,283,90,253,90,4, 64, 12);//body

drawQuad(250,50,286,50,281,88,255,88,217, 216, 208);

drawQuad(248,30,288,30,288,50,248,50,4, 64, 12);

drawCircle(255,40,5,252, 235, 106);//light
drawCircle(280,40,5,252, 235, 106);
glPopMatrix();
...
drawQuad(248,50,288,50,283,90,253,90,2, 43, 7);//body

drawQuad(250,50,286,50,281,88,255,88,217, 216, 208);

drawQuad(248,30,288,30,288,50,248,50,2, 43, 7);
...
if(light)
{
   drawQuad(250,40,240,15,270,15,260,40,240, 233, 22);
drawCircle(255,15,15,240, 233, 22);

drawQuad(275,40,265,15,295,15,285,40,240, 233, 22);
drawCircle(280,15,15,240, 233, 22);
}
...
//container
if(mode){
drawQuad(-250,15,-170,15,-170,76,-250,76,41, 77, 37);
drawQuad(-248,18,-172,18,-172,73,-248,73,85, 77, 37);
glBegin(GL_LINES);
glColor3f (0,0,0);
for(int i=-250,j=17; i<=-170; i+=5, j+=3)
{
   glVertex2i(i, 73);
   glVertex2i(i, 17);
}
...
// windmill  triangle 2 BUTTOM NEXT
//glColor3ub (255, 92, 51);
glPointSize(5.0);
glBegin(GL_TRIANGLES);
glVertex2i(-15, 160);
...
// windmill  triangle 3 LEFT UPPER
//glColor3ub (255, 92, 51);
glPointSize(5.0);
glBegin(GL_TRIANGLES);
glVertex2i(-100, 160);
...
// windmill  triangle 3 LEFT BUTTOM
//glColor3ub (255, 92, 51);
glPointSize(5.0);
glBegin(GL_TRIANGLES);
glVertex2i(-100, 50);
...
// windmill  triangle 3 LEFT BUTTOM LINE
glColor3ub (0, 0, 0);
glPointSize(5.0);
glBegin(GL_LINES);
glVertex2i(-100, 50);
...
// windmill  triangle 3 LEFT UPPER LINE
glColor3ub (0, 0, 0);
glPointSize(5.0);
glBegin(GL_LINES);
glVertex2i(-100, 160);
...
// windmill  triangle 2 BUTTOM NEXT LINE
glColor3ub (0, 0, 0);
glPointSize(5.0);
glBegin(GL_LINES);
glVertex2i(-15, 160);
...
// windmill RIGHT BELLOW TRIANGLE 1 LINE
glColor3ub (0, 0, 0);
glPointSize(5.0);
glBegin(GL_LINES);
glVertex2i(5, 60);
...
if(mode)
{
    drawCircle(-120,-90,40,101, 101, 110);//day
    drawCircle(-120,-90,37,0,0,0);
    drawQuad(-150,-100,-90,-100,-90,-90,-150,-90,84, 32, 8);
   // drawQuad(-140,-120,-120,-120,-120,-60,-130,-60,84, 32, 8);
    drawQuad(-130,-120,-120,-120,-120,-60,-130,-60,84, 32, 8);
}
else
{
     drawCircle(-120,-90,40,101, 101, 110);//night
     drawCircle(-120,-90,37,0,0,0);
    drawQuad(-150,-100,-90,-100,-90,-90,-150,-90,84, 32, 8);
    drawQuad(-130,-120,-120,-120,-120,-60,-130,-60,84, 32, 8);
    drawTriangle(-135,-90,-115,-90,-125,-50,255, 231, 10);
    drawTriangle(-135,-90,-115,-90,-140,-70,255, 231, 10);
    drawTriangle(-135,-90,-115,-90,-110,-70,255, 231, 10);
    drawTriangle(-135,-90,-115,-90,-135,-60,255, 231, 10);
    drawTriangle(-135,-90,-115,-90,-115,-60,255, 231, 10);
     drawCircle(-125,-90,10,255, 231, 10);
}
...
cout << "1. Press \"f\" for moving car Forward \n";
cout << "2. Press \"b\" for moving car Backward \n";
cout << "3. Press \"n\" for Night Mode View \n";
cout << "4. Press \"d\" for Day Mode View \n";
cout << "5. Press \"r\" for Rain \n";
cout << "6. Press \"e\" to stop Rain \n";
cout << "7. Press \"s\" to stop car \n";
